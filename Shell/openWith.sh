...
open() {
    case "$1" in
        ...
        *) python $HOME/Git/OneOffCodes/Python/paragraph_scraper.py --url "$1" && feh --scale-down /tmp/image* &! urxvtc -e "speedread -w 375 /tmp/para.txt && rm -f /tmp/image* && rm -f /tmp/para.txt"
