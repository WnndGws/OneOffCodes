...
lines=$(head -1 "$1" | sed -e 's|\ |\*|g' -e "s|'|\\\'|g" -e 's|\.|\*|g' | xargs -i find /home/wynand/wynZFS/Media/TV/ -iname "*{}*" | wc -l )
...
matches=$(head -1 "$1" | sed -e 's|\ |\*|g' -e "s|'|\\\'|g" -e 's|\.|\*|g' | xargs -i find /home/wynand/wynZFS/Media/TV/ -iname "*{}*" )
